...
$taskOrder = @{ arc_challenge = 0; arc_easy = 1; gsm8k = 2; humanevalplus = 3; mbppplus = 4; medqa = 5; gpqa = 6; aime2024 = 7; aime2025 = 8 }
$modelOrder = @{ "Qwen/Qwen3-4B" = 0; "Qwen/Qwen3-8B" = 1; "Qwen/Qwen3-14B" = 2 }
