...
PROGRESS_FILE="${PROGRESS_FILE:-${SUBMIT_DIR}/state_fast.txt}"
...
export FAST_ONLY=true FORCE_ALL PROGRESS_FILE TASKS_PER_GPU MAX_SAMPLES KERNEL_FEATURES
