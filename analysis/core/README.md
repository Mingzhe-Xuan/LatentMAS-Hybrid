...
transport accumulation for generated planner positions only, packs the aligned
plan before the native judger prompt, and explicitly drives greedy receiver decoding. STT planner contexts
